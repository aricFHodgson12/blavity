    ...
    >
      <ul class="mobile-menu__nav__mega-dropdown">
          ...
          >
            ...
            >
              ...
              <input
                ...
                required
              >
              <label for="termsCheck"><span class="mobile-menu__nav__mega-dropdown__col__newsletter__capture-form__checkbox__input-text">I agree to the &nbsp;<nuxt-link to="/terms-of-service">terms</nuxt-link>
        ...
        >
          ...
          <ul
            v-if="open.news"
            class="mobile-menu__nav__mega-dropdown__col__container"
          >
            <li
              v-for="(subCategory, index) in categories['news'].subCategories"
              :key="index"
              class="mobile-menu__nav__mega-dropdown__col__item"
            >
              <nuxt-link
