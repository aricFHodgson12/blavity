<template>
  ...
  >
    <div class="bo-mobile-menu__header">
      <div
        id="bo-mobile-menu-icon"
        class="bo-mobile-menu__header__toggler"
        @click="handleClick"
      >
      ...
      <div class="bo-mobile-menu__header__logo">
        <nuxt-link to="/">
          <img
            v-lazy="images.logo"
            alt="Blavity Original: News, Media, Business, Culture"
          >
        </nuxt-link>
      </div>
      <div
        v-if="open.nav"
        class="bo-mobile-menu__header__bo-mobile-search"
      >
        <a @click="openSearch">
          <img
      ...
      <div
        v-else
        class="bo-mobile-menu__header__newsletter-signup"
      >
        <no-ssr>
          <v-popover
            offset="24"
            placement="bottom"
            popover-class="bo-mobile-menu__header__newsletter-signup__subscribe-box"
          >
            <a
              class="bo-mobile-menu__header__bo-mobile-search"
              @click="openSearch"
    ...
    <div
      v-show="open.nav"
      id="mobile-toggle"
      class="bo-mobile-menu__nav"
    >
      <ul class="bo-mobile-menu__nav__mega-dropdown">
        <ul
          id="newsletter"
          class="bo-mobile-menu__nav__mega-dropdown__col"
        >
          <li class="bo-mobile-menu__nav__mega-dropdown__col__heading">
            <nuxt-link to="/">
          ...
          <div
            ...
            class="bo-mobile-menu__nav__mega-dropdown__col__newsletter"
          >
            <form
              v-if="!emailSubmitted"
              class="bo-mobile-menu__nav__mega-dropdown__col__newsletter__capture-form"
              @submit.prevent="submit"
            >
              <h3 class="bo-mobile-menu__nav__mega-dropdown__col__newsletter__capture-form__heading">
                Get the freshest stories in your inbox, <span>every day.</span>
              </h3>
              <span class="bo-mobile-menu__nav__mega-dropdown__col__newsletter__capture-form__email">
                <input
                  v-model="emailAddress"
                  class="bo-mobile-menu__nav__mega-dropdown__col__newsletter__capture-form__email__input"
                  type="email"
                  placeholder="Your Email Address"
                  required
                >
                <button
                  class="bo-mobile-menu__nav__mega-dropdown__col__newsletter__capture-form__email__submit"
                  type="submit"
                >
                  <img
                    v-lazy="images.arrow"
              ...
              <input
                id="termsCheck"
                class="bo-mobile-menu__nav__mega-dropdown__col__newsletter__capture-form__checkbox"
                type="checkbox"
                required
              >
              <label for="termsCheck"><span class="bo-mobile-menu__nav__mega-dropdown__col__newsletter__capture-form__checkbox__input-text">I agree to the &nbsp;<nuxt-link to="/terms-of-service">terms</nuxt-link>
                <span>&nbsp; & &nbsp;</span><nuxt-link to="/privacy">privacy</nuxt-link>&nbsp; policies.
              </span></label>
              <label
                v-show="emailError"
                class="bo-mobile-menu__nav__mega-dropdown__col__newsletter__capture-form__error-text"
              >Please use a valid email address</label>
            </form>

            <div
              v-else
              class="bo-mobile-menu__nav__mega-dropdown__col__newsletter__success"
            >
              <h2 class="bo-mobile-menu__nav__mega-dropdown__col__newsletter__success__heading">
        ...
        >
          ...
          <ul
            v-if="open.news"
            class="bo-mobile-menu__nav__mega-dropdown__col__container"
          >
            <li
              v-for="(subCategory, index) in categories['news'].subCategories"
              :key="index"
              class="bo-mobile-menu__nav__mega-dropdown__col__item"
            >
              <nuxt-link
        ...
        <ul class="bo-mobile-menu__nav__mega-dropdown__col">
          <li class="bo-mobile-menu__nav__mega-dropdown__col__item-head">
        ...
        <a
          class="bo-mobile-menu__nav__write"
      ...
      <footer class="bo-mobile-menu__nav__footer">
        <div class="bo-mobile-menu__nav__footer__links">
          <div class="bo-mobile-menu__nav__footer__links__my-account">
            <a
              v-if="isLoggedIn"
              href="http://editor.blavity.com/login"
            >
          ...
          <div class="bo-mobile-menu__nav__footer__links__sign-in">
            <a
              v-if="!isLoggedIn"
              href="http://editor.blavity.com/login"
            >
        ...
        <div class="bo-mobile-menu__nav__footer__social">
          <a
  ...
  methods: {
    handleScroll (e) {
      if (this.$mq === 'mobile' && this.$route && this.$route.name === 'blavity-original-slug') {
        const header = document.getElementById('bo-mobile-header')
    ...
    handleClick () {
      ...
      const menu = document.getElementById('bo-mobile-menu-icon')
      const nav = document.getElementById('mobile-toggle')
      const fullMenu = document.getElementById('bo-mobile-header')
...
<style lang="scss">
@import '~/stylesheets/components/_bo-mobile-nav-menu.scss';
</style>
