<template>
  <div
    ...
    class="bo-navigation-menu"
  >
    <!-- Left side of header container -->
    <div class="bo-navigation-menu__container">
      <div
        id="menu-icon"
        class="bo-navigation-menu__container__toggler"
        @click="handleClick"
      >
      ...
      <div class="bo-navigation-menu__container__text">
        <a @click="handleClick">
      ...
      <div
        v-if="!showSearch"
        class="bo-navigation-menu__container__text"
      >
        <a
          @click="toggleSearch"
        >
      ...
      <div
        v-else
        class="bo-navigation-menu__container__bo-search-bar"
      >
        <div
          @click="toggleSearch"
        >
    ...
    <div
      v-show="!showSearch"
      class="bo-navigation-menu__logo"
    >
      <nuxt-link to="/">
        <img
          v-lazy="images.logo"
    ...
    <div
      v-show="!showSearch"
      class="bo-navigation-menu__facebook-post"
      @click="popupClick"
    >
      <a
        class="bo-navigation-menu__facebook-post__content"
    ...
    <nav
      v-show="open"
      id="toggle"
      class="bo-navigation-menu__nav"
    >
      <ul class="bo-navigation-menu__nav__mega-dropdown">
        <ul class="bo-navigation-menu__nav__mega-dropdown__col">
          <li class="bo-navigation-menu__nav__mega-dropdown__col__heading">
          ...
          <li
            ...
            :key="index"
            class="bo-navigation-menu__nav__mega-dropdown__col__item"
          >
            <nuxt-link
      ...
      <div class="bo-navigation-menu__nav__block">
        <div class="bo-navigation-menu__nav__block__header">
          <div class="bo-navigation-menu__nav__block__header__primary">
            <span>Want to pitch a story that <em>matters to you?</em></span>
          </div>
          <a
            class="bo-navigation-menu__nav__block__header__secondary"
        ...
        <footer class="bo-navigation-menu__nav__block__footer">
          <div class="bo-navigation-menu__nav__block__footer__social">
            <nuxt-link to="/">
              Follow
            </nuxt-link>
            <a
          ...
          <div class="bo-navigation-menu__nav__block__footer__links">
            <a
              v-if="isLoggedIn"
              href="http://editor.blavity.com/login"
            >
            ...
            <span
              v-if="!isLoggedIn"
              class="bo-navigation-menu__nav__block__footer__links__sign-in"
            >
...
export default {
  ...
  methods: {
    handleScroll (e) {
      if (this.$mq === 'desktop' && this.$route && this.$route.name === 'blavity-original-slug') {
        const header = document.getElementById('bo-desktop-nav')
    ...
    handleClick () {
      ...
      const fullMenu = document.getElementById('bo-desktop-nav')
      if (open === false) {
...
<style lang="scss">
 @import '~/stylesheets/components/_bo-desktop-nav-menu.scss';
</style>
